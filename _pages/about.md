...
## Patents
* **秦善天**, 李文明, 范志华, 安学军, 叶笑春. 一种数据流架构的半集中式动态任务调度装置及方法 (A semi-centralized dynamic task scheduling device & method for dataflow architectures). Application No. 202510890805.6, 2025.
* **秦善天**, 李文明, 范志华, 安学军, 叶笑春, 范东睿. 一种数据流众核处理器的数据预取方法及处理器 (A data prefetching method & processor for datflow many-core architectures). Publication No. CN118132462A, 2024.
